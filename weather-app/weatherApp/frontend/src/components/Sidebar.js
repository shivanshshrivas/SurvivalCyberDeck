...
export default function Sidebar () {
    ...
    return (
        <div className="flex items-center justify-start h-screen absolute left-0 top-0 bg-[]">
            <div 
                className={`sidebar text-white px-2 pt-4 flex flex-col items-start justify-start h-full`}   
                >
                <div className={`home flex items-center justify-start duration-200 ease-in-out border border-transparent rounded-lg p-3 mb-4 overflow-hidden `}
                ...
                <div className={`radio flex items-center justify-start duration-200 ease-in-out border border-transparent rounded-lg p-3 mb-4 overflow-hidden `}
                ...
                <div className={`wifi flex items-center justify-start duration-200 ease-in-out border border-transparent rounded-lg p-3 mb-4 overflow-hidden `}
            ...
            <hr className="h-screen border-r border-[#bfbfbf] py-2"/>
        </div>
    );
}